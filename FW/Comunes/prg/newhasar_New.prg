...
Try
	...
	If ( Vartype( loHasar ) # 'O' ) And lHasar
		...
		Catch To oErr
			If oErr.ErrorNo = 1733 && No se encuentra la definición de clase HASAR.FISCAL.1.
				lHasar = .F.
	...
	If !lHasar And !llOnDestroy
		loHasar = Createobject( "Empty" )
		loGlobalSettings.oHasar = loHasar
		lnPuntoDeVenta = GetValue( "Sucu0", "ar0Est", 1 )

		AddProperty( loHasar, "nPuntoDeVenta", lnPuntoDeVenta )
		AddProperty( loHasar, "cModelo", "" )
		AddProperty( loHasar, "nModelo", MODELO_715 )
