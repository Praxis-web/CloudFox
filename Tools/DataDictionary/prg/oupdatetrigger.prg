...
* oUpdateTrigger
* Clase Trigger.
Define Class oUpdateTrigger As oTrigger Of 'Tools\DataDictionary\prg\oTrigger.prg' 

    #If .F.
        Local This As oUpdateTrigger Of 'Tools\DataDictionary\prg\oUpdateTrigger.prg'
    #Endif
...
*!* ///////////////////////////////////////////////////////
*!* Procedure.....: <<This.Name>>
*!* Description...: Update Trigger for <<This.cChildTable>>
*!* -------------------------------------------------------
*!*
*!*
...
Procedure <<This.Name>>
	...
	Try
		...
		If <<This.cTriggerConditionForUpdate>>

			luForeignKey = <<This.cChildForeignKey>>

			If Oldval( '<<This.cChildForeignKey>>' ) # luForeignKey
		...
		If ! llOk
			...
			Else
				Error "Error al Actualizar en Tabla <<This.cChildTable>> " +;
