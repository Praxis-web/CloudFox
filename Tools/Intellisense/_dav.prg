...
TEXT To lcCode NoShow
    ...
    Set Century On
    lcRet = '* David ' + Transform( Year( Date() ) ) + '-' + Transform( Month( Date() ) , '@L 99' ) + '-' +  Transform( Day( Date() ) , '@L 99') + '(' + Time() + ')'
...
Delete From UdpFoxCode Where Type = 'U' And ABBREV = '_dav'
insert into UdpFoxCode ( Type, ABBREV, cmd, Data )  Values ( 'U', '_dav', '{}', lcCode )
Use In Select( 'UdpFoxCode' )